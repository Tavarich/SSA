...
class YTVOSDatasetMapper:
    ...
    def __init__(
        ...
        self.dataset_name = src_dataset_name.split('_')[0]
    ...
    def __call__(self, dataset_dict):
        ...
        video_annos = dataset_dict.pop("annotations", None)  # list of dict
        file_names = dataset_dict.pop("file_names", None)  # list of file_names

        if self.is_train:
            _ids = set()
            for frame_idx in selected_idx:
                _ids.update([anno["id"] for anno in video_annos[frame_idx]])  # get all object ids
            ids = dict()
        ...
        for frame_idx in selected_idx:
            ...
            annos = [_transform_instance_annotations_ytvos(obj, transforms, image_shape)
        ...
        dataset_dict['dataset_name'] = 'ytvos'

        return dataset_dict

def _transform_instance_annotations_ytvos(annotation, transforms, image_size):
    ...
    if "segmentation" in annotation:
        ...
        mask = (mask == annotation['id']).astype(np.uint8)
