...
if __name__ == '__main__':
    ...
    parser.add_argument("--davis_exp_path", type=str, default="datasets/ref-davis/meta_expressions/valid/meta_expressions.json")
    parser.add_argument("--davis_anno_path", type=str, default="datasets/ref-davis/valid/Annotations")
